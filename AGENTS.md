...
`opencode-okf-context` is an [OpenCode](https://opencode.ai) plugin (v0.1.1, MIT) that brings
...
distribution is `opencode-okf-context-0.1.1-offline.tar.gz` (contains `okf.js` + `INSTALL.txt` +
